...
# include_directories(${EMsoftOO_BINARY_DIR}/EMsoftOOLib)
# include_directories(${EMsoftOOLib_BINARY_DIR})

macro (EMsoftOO_SetupInstallDirs)
  set(install_dir "bin")
  ...
  if(APPLE)
    ...
    set(install_dir "${EMsoftOO_PACKAGE_DEST_PREFIX}/")
    set(lib_install_dir "${EMsoftOO_PACKAGE_DEST_PREFIX}/lib")
    set(extra_install_dir "${EMsoftOO_PACKAGE_DEST_PREFIX}/bin")
    set(include_install_dir "${EMsoftOO_PACKAGE_DEST_PREFIX}/include")
    set(top_install_dir "${EMsoftOO_PACKAGE_DEST_PREFIX}/")
...
function(Add_EMsoftOO_Executable)
  set(options )
  ...
  BuildToolBundle(TARGET ${Z_TARGET}
                ...
                VERSION_MAJOR ${EMsoftOO_VER_MAJOR}
                VERSION_MINOR ${EMsoftOO_VER_MINOR}
                VERSION_PATCH ${EMsoftOO_VER_PATCH}
                BINARY_DIR ${EMsoftOO_BINARY_DIR}/Applications/${Z_TARGET}
  ...
  set_target_properties(${Z_TARGET} PROPERTIES BUILD_RPATH "${EMsoftOO_OpenMP_LIB_DIR}")
...
#---------------------------------------------------------------------
# This function will add a new EMsoftOO unit test
function(AddEMsoftOOUnitTest)
    set(options)
    ...
    set(TEST_SOURCE_FILE "${EMsoftOO_BINARY_DIR}/${Z_SOLUTION_FOLDER}/${Z_TEST_NAME}Test.cpp")
    configure_file("${EMsoftOO_SOURCE_DIR}/Source/Test/UnitTestMain.cpp.in"
